    ...
    var getCalculate = {
        ...
        defaultTitles: {
            ...
            es: {
                ...
                group_instrument: "Grupo de herramientas",
            ...
            de: {
                ...
                group_instrument: "Werkzeuggruppe",
            ...
            fr: {
                ...
                group_instrument: "Groupe d'outils",
        ...
        getBuild: function(lang, idBlock) {
            ...
            if (mainBlock) {
                ...
                if (this.defaultTitles[lang]) {
                    ...
                    innerHTMLcontent += '<input class="clc-controlBox__input" type="text" name="_tr_order_transaction_volume" id="_tr_order_transaction_volume" onkeyup="getCalculate.numberChange(this)" step="0.01" max="1000000" min="0" dolya="2" value="' + this.defaultValueVolume + '">';
                    ...
                    innerHTMLcontent += '<div class="clc-controlBox clc-field">';
                    innerHTMLcontent += buttonMinus;
                    innerHTMLcontent += '<input class="clc-controlBox__input" type="text" name="_tr_price_open" id="_tr_price_open" onkeyup="getCalculate.numberChange(this)" step="0.00001" max="1000000" min="0.00000" dolya="5" value="' + this.defaultValuePrices + '">';
                    innerHTMLcontent += buttonPlus;
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '<div class="clc-calculator__block clc-calculator__block--control">';
                    ...
                    innerHTMLcontent += '<div class="clc-controlBox clc-field">';
                    innerHTMLcontent += buttonMinus;
                    innerHTMLcontent += '<input class="clc-controlBox__input" type="text" name="_tr_price_close" id="_tr_price_close" onkeyup="getCalculate.numberChange(this)" step="0.00001" max="1000000" min="0.00000" dolya="5" value="' + this.defaultValuePrices + '">';
                    innerHTMLcontent += buttonPlus;
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
                    ...
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-not-background btn-second" onclick="getCalculate.cleanAll(\'' + langBuild + '\');">' + this.defaultTitles[langBuild].resetBtn + '</button>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
